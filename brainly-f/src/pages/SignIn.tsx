...
export function SignIn(){
  ...
  return(
    <div className="w-screen h-screen flex-col  justify-center bg-[url('./images/bg-2.png')]  flex">
      ...
      <div className="  flex justify-center h-[400px]">
        ...
        <div className="p-6 pt-6 h-[60vh] sm:h-full w-[60%] sm:w-[45%] bg-black/30 backdrop-blur-2xl rounded-md flex-col border border-white/10">
